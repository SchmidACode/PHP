<form action="index.php" method="post">
    <h1>Выберите Ваш любимый цвет:</h1>
        <div class="radiobutton">
            <input type="radio"name="color"value="green"id="green"><label for="green">Green</label><br>
            <input type="radio"name="color"value="black"id="black"><label for="black">Black</label><br> 
            ...
            <input type="radio"name="color"value="white"id="white"><label for="white">White</label><br>
        </div>
